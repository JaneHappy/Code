# coding: utf-8
# https://github.com/nfmcclure/tensorflow_cookbook/blob/master/08_Convolutional_Neural_Networks/04_Retraining_Current_Architectures/04_download_cifar10.py#L4
