...
#------------------------------------
'''
Refer BUG: https://github.com/tensorflow/models/issues/857
...
2017-07-15 22:15:37.993294: W tensorflow/core/platform/cpu_feature_guard.cc:45] The TensorFlow library wasn't compiled to use SSE4.1 instructions, but these are available on your machine and could speed up CPU computations.
2017-07-15 22:15:37.998053: W tensorflow/core/platform/cpu_feature_guard.cc:45] The TensorFlow library wasn't compiled to use SSE4.2 instructions, but these are available on your machine and could speed up CPU computations.
2017-07-15 22:15:38.002396: W tensorflow/core/platform/cpu_feature_guard.cc:45] The TensorFlow library wasn't compiled to use AVX instructions, but these are available on your machine and could speed up CPU computations.
After 0 training step(s), validation accuracy using average model is 0.096 
After 10 training step(s), validation accuracy using average model is 0.5782 
After 20 training step(s), validation accuracy using average model is 0.5442 
After 30 training step(s), validation accuracy using average model is 0.5918 
After 40 training step(s), validation accuracy using average model is 0.6328 
After 50 training step(s), validation accuracy using average model is 0.599 
After 60 training step(s), validation accuracy using average model is 0.621 
After 70 training step(s), validation accuracy using average model is 0.6908 
After 80 training step(s), validation accuracy using average model is 0.6748 
After 90 training step(s), validation accuracy using average model is 0.696 
After 100 training step(s), test accuracy using average model is 0.6749
[Finished in 12.8s]
